...
import com.pro.customize.database.FoodDatabase;
import com.pro.customize.databinding.ActivityFoodDetailBinding;
import com.pro.customize.event.ReloadListCartEvent;
...
public class FoodDetailActivity extends BaseActivity {
    ...
    private void setDataFoodDetail() {
        ...
        GlideUtils.loadUrlBanner(mFood.getImage(), mActivityFoodDetailBinding.imageFood);
    ...
    public void onClickAddToCart() {
        ...
        tvSubtractCount.setOnClickListener(v -> {
            ...
            int totalPrice1 = mFood.getPrice() * newCount;
        ...
        tvAddCount.setOnClickListener(v -> {
            ...
            int totalPrice2 = mFood.getPrice() * newCount;
